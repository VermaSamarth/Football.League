        ...
        <div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div style="display: flex; justify-content: center; align-items: center; background-color:rgb(248, 138, 138); border-radius: 10px; padding: 20px;margin-bottom: 20px;">
                    <form action="{{route('add_new_manager')}}" method="post" style="align-content: center" enctype="multipart/form-data" >
                        @csrf
                        <table class="table-auto border-collapse w-full">
                            ...
                            <tbody style="text-align: center;border border-white-400 px-4 py-2">
                                ...
                                <tr>
                                    <td class="px-4 py-2"><label for="fname" style="color: white"><strong>First Name:</strong></label></td>
                                    <td class=" px-4 py-2"><input type="text" id="fname" name="fname" placeholder="Enter the first name" required><br><br></td>
                                </tr>

                                <tr>
                                    <td class="px-4 py-2"><label for="lname" style="color: white"><strong>Last Name:</strong></label></td>
                                    <td class=" px-4 py-2"><input type="text" id="lname" name="lname" placeholder="Enter the last name" required><br><br></td>
                                </tr>
                                
                                <tr>
                                    <td class="px-4 py-2"><label for="nationality" style="color: white"><strong>Nationality</strong></label></td>
                                    <td class=" px-4 py-2"><input type="text" id="nationality" name="nationality" placeholder="Enter the nationality" required><br><br></td>
                                </tr>
