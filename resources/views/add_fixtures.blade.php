        ...
        <div>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div style="display: flex; justify-content: center; align-items: center; background-color:rgb(248, 138, 138); border-radius: 10px; padding: 20px;margin-bottom: 20px;">
                    <form action="{{route('add_new_schedule')}}" method="post" style="align-content: center" enctype="multipart/form-data" >
                        @csrf
                        ...
                        <table class="table-auto border-collapse w-full">
                            ...
                            <tbody style="text-align: left;border border-white-400 px-4 py-2">
                                ...
                                <tr>
                                    ...
                                    <td class=" px-4 py-2"><input type="date" id="matchday" name="matchday" placeholder="Enter the match date" required><br><br></td>
                                </tr>
                                
                                <tr>
                                    <td class=" px-4 py-2"><label for="venue" style="color: white"><strong>Match Venue:</strong></label></td>
                                    <td class=" px-4 py-2"><input type="text" id="venue" name="venue" placeholder="Enter the stadium name" required><br><br></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class=" px-4 py-2"><input type="text" id="referee1" name="referee1" placeholder="Enter the referee 1 " required><br><br></td>
                                </tr>
...
{{-- <label for="home_id" style="color: white"><strong>Home Team ID:</strong></label>
                        <input type="number" id="home_id" name="home_id" placeholder="Enter the team name" required><br><br>

                        <label for="away_id" style="color: white"><strong>Away Team ID:</strong></label>
                        <input type="number" id="away_id" name="away_id" placeholder="Enter the team name" required><br><br> --}}
                        
                        {{-- <label for="matchday" style="color: white"><strong>Date of MatchDay:</strong></label>
                        <input type="date" id="matchday" name="matchday" placeholder="Enter the match date" required><br><br>
                    
                        <label for="venue" style="color: white"><strong>Venue:</strong></label>
                        <input type="text" id="venue" name="venue" placeholder="Enter the stadium name" required><br><br> --}}
                        
                        {{-- <label for="home_goals" style="color: white"><strong>Home Team Goals:</strong></label>
                        <input type="number" id="home_goals" name="home_goals" placeholder="Enter the home goals" ><br><br>

                        <label for="away_goals" style="color: white"><strong>Away Team Goals:</strong></label>
                        <input type="number" id="away_goals" name="away_goals" placeholder="Enter the awayy goals" ><br><br> --}}

                        {{-- <label for="referee1" style="color: white"><strong>Referee 1::</strong></label>
                        <input type="text" id="referee1" name="referee1" placeholder="Enter the referee 1 " required><br><br>

                        <label for="referee2" style="color: white"><strong>Referee 2:</strong></label>
                        <input type="text" id="referee2" name="referee2" placeholder="Enter the referee 2" required><br><br> --}}
                    
                        {{-- <label for="status" style="color: white"><strong>Status:</strong></label>
                        <input type="number" id="status" name="status" placeholder="Status 1 or 0" ><br><br>

                        <label for="winner_id" style="color: white"><strong>Winner ID:</strong></label>
                        <input type="number" id="winner_id" name="winner_id" placeholder="Enter the winner id" ><br><br> --}}